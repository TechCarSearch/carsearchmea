                        ...
                        <div class="wrap">
                            <div class="bx-left">
                                <div class="carslider">
                                    <div class="item"  v-for="imgg in imagelist">
                                        <img :src="usedcar_slider_image_url + imgg.image" alt="">
                                    </div>
                            ...
                            <div class="bx-right">
                                ...
                                <div class="car-info-box">
									<div class="content">
									    <h4 class="title">
                                            {{list.car_name == '' || list.car_name == null ? 'N/A' : list.car_name}}
										</h4>
										<div class="startRating">
									        ...
									        <router-link :to="{ name: 'usedcar-review', params: {id: list.id }}" class="bottomText">
                        ...
                        <div class="col-md-9 p0">
                            ...
                            <div class="bx-details bx-details4">
                                ...
                                <div class="box4">
                                    ...
                                    <div class="tab-content" v-for="que in question_list">
							                ...
							                <div class="question-slider">
							                    <div class="queans">
                                                    ...
                                                    <div class="answer-link">
                                                        <ul>
                                                            <li>
                                                            <router-link :to="{ name: 'usedcar-question-answer', params: {id: que.id }}">View Answer <i class="drpdown"></i></router-link>
                                                            </li>
                                                        </ul>
							                        </div>
							                    </div>
...
export default {
    ...
    methods: {
        ...
        console.log(id);
       axios
          .get(base_url + "api/precardetails/" + id , {
    ...
    $('.item-content').scrollSpy({
      ...
      setRating : function(){
          ...
          //vm.userid = vm.userid;
          axios
          .post(base_url + "api/usedcarstarrating", params, {
            "Access-Control-Allow-Origin": "*",
            "Content-Type": "application/json"
          })
        ...
        addquestion : function(){
          ...
          if(vm.question != ''){
          axios
          .post(base_url + "api/addusedcarquestion", params, {
            "Access-Control-Allow-Origin": "*",
            "Content-Type": "application/json"
          })
