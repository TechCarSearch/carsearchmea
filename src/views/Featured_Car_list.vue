  ...
  v-if="myData==0">
    ...
    <div v-if="myData==1">-->
		...
		<section class="featuredCars new-car carlist">
			<div class="container">
				<h1 class="head">Featured Cars</h1>
				<div class="row">
					<div class="wrap">
							...
							<div class="card shadowWPadding">
								<div class="gsc_col-xs-12 paddingnone imgTopRound hover">
									<div class="imageTransition">
										...
										<img :src="car_image_url + cars.featured_image"></router-link>
									</div>
								</div>
							    <div class="gsc_col-xs-12 holder ">
									<router-link :to="{ name: 'car-details', params: {id: cars.id }}" class="title">
										{{ cars.car_name=='' || cars.car_name == null ? 'N/A' : cars.car_name }}</router-link>
...
export default {
	...
	methods: {
		...
		loadData: function() {
			...
			vm.isLoading = true;
			axios
          		.get(base_url + "api/featuredcarlist",  {
