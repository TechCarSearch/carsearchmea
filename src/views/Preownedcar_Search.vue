  ...
  <span class="loader-inner"></span>
        ...
        <!--<div id="sortby" class="sortby modal" role="dialog" aria-modal="true">
	        <div class="modal-dialog">
	            ...
	            <h2>Sort by :</h2>
	            <ul class="sortbymob" v-model="searchId" @change="sideSearch()">
                    <li v-bind:value="1">Price - Low to High</li>
                    <li v-bind:value="2">Price - High to Low</li>
                    
                    <li v-bind:value="4">Latest</li>	
	            </ul>
	        </div>
	    </div>-->
        <div id="sortby" class="sortby modal" role="dialog" aria-modal="true">
		            ...
		            <div id="filterpopup" class="filterpopup modal col-md-4 col-lg-3 col-left" role="dialog" aria-modal="true">
                        <div class="modal-wrap">
	                        <span class="close3" data-dismiss="modal">×</span>
									            ...
									            <div class="content">
										            <div class="check-box">
											            <div class="form-check form-check-inline">
												            ...
												            <span class="checkmark"></span>
												            <label class="form-check-label brand-label" for="b142">
													        {{brand.name == '' || brand.name == null ? 'N/A' : brand.name}} <span class="count"></span>
												            </label>
											            </div>
										            </div>
									            </div>
                                                    ...
                                                    <div class="check-box">
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label brand-label" for="mo677">
                                                                {{model.name == '' || model.name == null ? 'N/A' : model.name}} <span class="count"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="applybutton"><button class="filter-btn price-btn apply-btn" type="button">Apply Now</button></div>
                            </div>
                        </div>
                    </div>
				        ...
				        <div class="right-area">
				            <div class="item-filter">
					            <div class="filter-selcted">
                                   ...
                                   <ul class="filter_rslt" v-if="age_serach != ''">
                                        <li>
                                            <button class="close-btn"  @click='removeSearchage()'>{{age_serach}} <i class="fa fa-closet">x</i> </button>
                                        </li>
                                   </ul>
						        ...
						        <div class="row">
							        <div class="col-12 info-wrap" v-for="cars in car_list">
								        <div class="car-info-box" href="">
									        <div class="img-area">
									            <a href="cars-details.html"><img class="light-zoom" :src="usedcar_image_url + cars.featured_image" alt=""></a>
									        </div>
									        ...
									        <div class="content">
										        ...
										        <div class="footer-area">
										            <div class="left-area nncls">
                                                        <p class="price"><span>{{cars.currency_code == '' || cars.currency_code == null ? 'N/A' : cars.currency_code}}</span> 
                                                        {{cars.price == '' || cars.price == null ? 'N/A' : cars.price}}
                                                        </p>
										            </div>
										        </div>
										        <ul class="detailbox1">
										        ...
										        <router-link :to="{ name: 'precar-details', params: {slug: cars.slug, id: cars.id }}" class="viewdetailsbtn">
...
export default {
    ...
    methods: {
        ...
        loadData: function() {
            ...
            vm.myData=0;
            vm.isLoading = true;
            var mobileAgechkey = this.$route.query.mobileAgechkey;
            ...
            var agesearchkey = this.$route.query.agesearchkey;
            var brandid = this.$route.params.id;
            axios
                .get(base_url + "api/advance_search_preownedcar",  {
                ...
                .then(function(response) {
                   ...
                   // vm.filteredBrands = response.data.brand_list;
                    ...
                    if(brandsearchkey != undefined && agesearchkey != undefined){

                            vm.brandKey.push(brandsearchkey);
                            vm.agesearchkey=agesearchkey;
                            vm.updateSearch();
                    }
                    ...
                    if(pricesearchkey != undefined && agesearchkey != undefined){
                    ...
                    if(mobileAgechkey != undefined)
                    {
                            vm.agesearchkey=mobileAgechkey;
                            vm.updateSearch();
                    }
        ...
        updateSearch:function () {
            ...
            var params = {
                ...
                agesearchkey:vm.agesearchkey
            };
            axios
            .post(base_url + "api/advance_preownedcar_filter_search", params, {
              "Access-Control-Allow-Origin": "*",
              "Content-Type": "application/json"
            })
            .then(function(response) {
              ...
              vm.age_serach = response.data.age_serach;
        ...
        loadMore : function()
        {
            ...
            vm.isLoading = true;
            axios
                .get(base_url + "api/advance_search_preownedcar?" + vm.page + "=" + vm.nextpage, {
                    "Access-Control-Allow-Origin": "*",
                    "Content-Type": "application/json"
                })
        ...
        loadMore1 : function()
        {
            ...
            axios
                .post(base_url + "api/advance_preownedcar_filter_search?" + vm.page + "=" + vm.nextpage,params, {
                    "Access-Control-Allow-Origin": "*",
                    "Content-Type": "application/json"
                })
                .then(async function(response) {
