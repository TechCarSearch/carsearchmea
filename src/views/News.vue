                  ...
                  <div class="entry-footer">
                    <div class="wrap-post-btn">
                      ...
                      <a class="post-btn btn-effect">
                        <router-link :to="{ name: 'news-details', params: { slug: blog.slug, id: blog.id }}" class="post-btn__inner">
               ...
               <!-- <div
                ...
                >
                  ...
                  <form id="geniusform">
                    ...
                    <button class="btn btn-primary btn-round submit" type="submit">Subscribe</button>
                  </form>
                </div>-->
      ...
      loadData: function() {
        ...
        axios
          ...
          .then(function(response) {
            vm.myData=1;
            vm.isLoading = false;
             vm.list = response.data.news_list;
             console.log(vm.list);
          });
            ...
            axios
            .post(base_url + "api/serachnews", params, {
              "Access-Control-Allow-Origin": "*",
              "Content-Type": "application/json"
            })
            ...
            .then(function(response) {
             ...
             // vm.list1=response.data;
              vm.list = response.data.news_list.data;
        ...
        if (vm.searchkey != "") {
          axios
            ...
            .then(function(response) {
             ...
             // vm.list1=response.data;
              vm.list = response.data.news_list.data;
              console.log(response.data.news_list.data);
            })   
        }
      },
